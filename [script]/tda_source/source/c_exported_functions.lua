function createGuassianBlur(posX,posY,sizeX,sizeY,colorR,colorG,colorB,colorA,MultiplierX,MultiplierY,Intensity,postGUI)
	...
	setScreenResolutionMultiplier( MultiplierX, MultiplierY )
...
function setBlurBoxEnabled(w,isEnabled)
	...
	if boxTable.inputBox[SHPelementID] and (type(isEnabled) == "bool") then 
